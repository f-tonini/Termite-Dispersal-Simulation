#--------------------------------------------------------------------------------
# Name:         CA_Simple.r
# Purpose:      Cellular Automata Simulation test file. Stand-alone script. 
...
##remove initial pixels falling inside unsuitable habitat
#init <- habitat.survival(init$age, init$rr)
